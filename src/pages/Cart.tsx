...
const Cart = () => {
  ...
  const { cartItems, getCart, updateCartQty, setCartItems } = useCartContext()
  const { placeOrder } = useOrderContext()

  useEffect(() => {
    getCart()
    return () => { setTotalAmount(0); setTotalItems(0); setCartItems([]); }
  }, [])
      ...
      :<div className="col-md-12 p-0">
        <div className="row">
          ...
          <div className="col-md-4">
            <h5 className='mt-5'>Payment and Shiping Details</h5>
            <div className="mb-3">
